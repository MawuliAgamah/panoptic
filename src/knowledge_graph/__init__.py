...
def create_client(
    ...
    """
    Create a knowledge graph client with settings.
    
    Args:
        settings: Optional Settings object. If None, will load from environment.
    ...
    return KnowledgeGraphClient(settings=resolved_settings)
