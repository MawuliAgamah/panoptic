...
INSERT_DOCUMENT_ONTOLOGY_TABLE = """
INSERT INTO document_ontologies (document_id, specification, status, version, proposed_by, reviewed_by, created_at, approved_at, is_canonical)
VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?);
"""

# CREATE_INDEX_DOCUMENT_ONTOLOGY_DOCUMENT_VERSION = """
# CREATE INDEX IF NOT EXISTS idx_document_ontologies_document_version
# ON document_ontologies (document_id, version);
# """

# CREATE_INDEX_DOCUMENT_ONTOLOGY_STATUS = """
